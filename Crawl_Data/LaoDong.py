...
import os
import json
"""file_path = os.path.join('D:\pythonProject\LAODONGJson','the-thao2p.json')
...
def Create_Data_frame(link, page_content, page_img, page_cap, muc, linh_vuc, ten_json_file):
    ...
    file_path = os.path.join('D:\pythonProject\LAODONGJson', f'{ten_json_file}1p.json')
